...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_TRA_MENU_11 = new NavigationLocation("AGENTS29376", "TRA_Menu_11", "Agent") { vueRouteName = "menu-TRA_11" };


		//
		// GET: /Agent/TRA_Menu_11
