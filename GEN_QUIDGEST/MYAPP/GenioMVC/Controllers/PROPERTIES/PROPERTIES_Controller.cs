...
namespace GenioMVC.Controllers
{
	public partial class PropertiesController : ControllerBase
	{
		...
		public PropertiesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION PROPERTIES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAproperties>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER PROPERTIES]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Properties row = new Models.Properties(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("properties");
		...
		{
			return GenericRecalculateFormulas(formData, "properties",
				(primaryKey) => Models.Properties.Find(primaryKey, UserContext.Current, "FF_PROPERTY"),
				(model) => formData.MapToModel(model as Models.Properties)
			);
		}
		...
		{
			return base.GetDocumsTickets("PROPERTIES", requestModel.FieldName, requestModel.KeyValue);
		}
