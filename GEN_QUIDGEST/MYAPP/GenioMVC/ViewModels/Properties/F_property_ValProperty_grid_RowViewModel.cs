...
public class F_property_ValProperty_grid_RowViewModel : Models.Properties
{
	#region Constructors
	...
	public F_property_ValProperty_grid_RowViewModel(UserContext userContext, CSGenioAproperties val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
