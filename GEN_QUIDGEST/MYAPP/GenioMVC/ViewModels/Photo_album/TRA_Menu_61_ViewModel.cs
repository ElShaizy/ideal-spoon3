...
{
	public class TRA_Menu_61_ViewModel : MenuListViewModel<Models.Photo_album>
	{
		/// <summary>
		...
		public override string Uuid => "78f1c5ba-c507-44a4-8a0b-ed82f4f2e47c";
...
// USE /[MANUAL TRA LIST_LIMITS 61]/
		...
		public override List<Exports.QColumn> GetColumnsToExport()
		{
			return
			[
				new Exports.QColumn(CSGenioAphoto_album.FldTitle, FieldType.TEXT, Resources.Resources.TITLE21885, 30, 0, true),
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Photo_album.AddEPH<CSGenioAphoto_album>(ref u, crs, "ML61");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Photo_album.AddEPH<CSGenioAphoto_album>(ref u, null, "ML61"));
			}
...
// USE /[MANUAL TRA OVERRQ 61]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAphoto_album>(m_userContext, false, ref tra_menu_61Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRA OVERRQLIST 61]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAphoto_album.GetInformation(), QMVC_POS_RECORD, sorts, tra_menu_61Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAphoto_album> listing = Models.ModelBase.Where<CSGenioAphoto_album>(m_userContext, distinct, tra_menu_61Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<TRA_Menu_61_RowViewModel> MapTRA_Menu_61(ListingMVC<CSGenioAphoto_album> Qlisting)
		{
		...
		private TRA_Menu_61_RowViewModel MapTRA_Menu_61(CSGenioAphoto_album row)
		{
			...
			foreach (RequestedField Qfield in row.Fields.Values)
			{
				switch (Qfield.Area)
				{
					...
					case "properties":
						model.Properties.klass.insertNameValueField(Qfield.FullName, Qfield.Value); break;
					default:
						break;
				}
			}
...
// USE /[MANUAL TRA VIEWMODEL_CUSTOM TRA_MENU_61]/
		...
		[
			...
			new TableSearchColumn("Properties_ValTitle", CSGenioAproperties.FldTitle, typeof(string)),
		];
