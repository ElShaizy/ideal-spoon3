...
namespace GenioMVC.Models
{
	public class Properties : ModelBase
	{
		...
		[ShouldSerialize("Properties.ValBuildingtype")]
		...
		[ShouldSerialize("Properties.ValTypology")]
		...
		[DisplayName("groundsize")]
		/// <summary>Field : "groundsize" Tipo: "N" Formula:  ""</summary>
		[ShouldSerialize("Properties.ValGroundsize")]
		[NumericAttribute(0)]
		...
		[ShouldSerialize("Properties.ValFloornumber")]
		[NumericAttribute(0)]
		...
		[ShouldSerialize("Properties.ValSolddate")]
		[DataType(DataType.Date)]
		[DateAttribute("D")]
