...
namespace GenioMVC.Models
{
	public class City : ModelBase
	{
		...
		public virtual Country Country
		{
			get
			{
				if (!isEmptyModel && (_country == null || (!string.IsNullOrEmpty(ValCodcountry_fk) && (_country.isEmptyModel || _country.klass.QPrimaryKey != ValCodcountry_fk))))
					_country = Models.Country.Find(ValCodcountry_fk, m_userContext, Identifier, _fieldsToSerialize);
