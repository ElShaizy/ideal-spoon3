...
public class F_brokerForm : Form
{
	...
	/// brokers information
	/// </summary>
	public CollapsibleZoneControl PseudNewgrp01 => new CollapsibleZoneControl(driver, ContainerLocator, "#F_BROKERPSEUDNEWGRP01-container");
	...
	/// Phone Number
	/// </summary>
	public BaseInputControl BrokerPhone_number => new BaseInputControl(driver, ContainerLocator, "container-F_BROKER__BROKER__PHONE_NUMBER", "#F_BROKER__BROKER__PHONE_NUMBER");
