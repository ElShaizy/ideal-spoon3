<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-contact-properties-title-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_CONTACT__PROPERTIES__TITLE_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FContactPropertiesTitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_CONTACT__PROPERTIES__TITLE_SeeMore', false),

				interfaceMetadata: {
					id: 'F_CONTACT__PROPERTIES__TITLE_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_CONTACT__PROPERTIES__TITLE_SeeMore',
					name: 'F_CONTACT__PROPERTIES__TITLE_SeeMore',
					controller: 'CONTACT',
					action: 'F_CONTACT_PropertiesValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-contact-properties-title',
				dismissAction: this.close,
				returnElement: 'F_CONTACT__PROPERTIES__TITLE_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-contact-properties-title')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'F_contact_F_contact_PropertiesValTitle',
